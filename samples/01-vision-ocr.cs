...
// 01-vision-ocr.cs — a vision LLM behind IOcrClient (the transcribe-by-seeing archetype).
//
...
// no structured tables/bbox/confidence, nondeterministic). Same IOcrClient contract; this is the
